from rest_framework.generics import GenericAPIView, CreateAPIView, UpdateAPIView, DestroyAPIView, ListAPIView
...
class CommonView(CreateAPIView, UpdateAPIView, DestroyAPIView, ListAPIView):
